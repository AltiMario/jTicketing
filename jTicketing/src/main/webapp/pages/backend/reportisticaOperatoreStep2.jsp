...
<div class="main_center">
	<h3><a href="./processReportisticaOperatoreStep3.do?dispatch=get&uid=<bean:write name="objElemento" property="uid" />"><bean:write name="objElemento" property="titolo" /></a></h3>
	<div class="left_box2">
