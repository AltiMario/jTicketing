   ...
   <bean:define id="ticketSelezionato" name="ticketSelezionato" scope="session" type="it.openprj.jTicketing.blogic.model.entity.Ticket"/>
		<table width="100%" border="0" cellspacing="1" cellpadding="1">
		  <tr>
		    ...
		    <td align="left"><b><bean:message key="label.ticketTitle"/></b><bean:write name="ticketSelezionato" property="titolo" /></td>
		  </tr>
		  <tr>
		    <td align="left"><b><bean:message key="label.ticketDescription"/></b> <bean:write name="ticketSelezionato" property="descrizione" /></td>
		  </tr>
		  <tr>
		    <td align="left"><b><bean:message key="label.category"/></b>
...
<div class="main_center">
<h3><bean:message key="message.SelectTicket"/></h3>
<div style="background-color: #f5f5f5;">
		...
		<table width="100%" border="0" cellpadding="3" cellspacing="3">
		  <tr>
		   <td rowspan="3" width="20"><html:radio property="selTicket"  value="<%=String.valueOf(indiceElemento.intValue())%>" /></td>
		    <th width="10%"><b><bean:message key="label.Ticket"/></b></th>
...
<html:submit accesskey="T"  titleKey="button.Go"	altKey="button.Go" styleClass="submit" property="isChange"><bean:message key="button.End" /></html:submit>
</p>
</div>
</div>
 </div>
