...
<html:form method="get" action="/processLuoghiInteresseWizard.do">
...
<p><img src="./images/success.png" align="top"/> <bean:message key="message.selectPlaceAndPushButton"/></p><BR/>
<p><img src="./images/info.png" align="top"/> <bean:message key="message.informationAboutCategoryTicketsAndPrice"/></p><BR/>
<p><img src="./images/alert.png" align="top"/><b><bean:message key="message.attentionStartConfiguration"/></b></p><BR/>
<div align="right">
