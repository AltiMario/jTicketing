...
<table border="0" cellpadding="1" cellspacing="1" width="98%"
	...
	<logic:iterate id="objTicket" name="listaTickets"
		...
		<tr>
			...
			<p align="right">
				<a href="./processTicketSearchBoxOffice.do?uid=<bean:write name="objElemento" property="uid" />&uidTicket=<bean:write name="objTicket" property="uid" />"><bean:message key="label.select" /></a>
			</p>
			</td>
		</tr>
	</logic:iterate>
