...
public class ProcessReportisticaOperatoreStep1Action extends DispatchAction {
	...
	public ActionForward get(ActionMapping mapping, ActionForm form, HttpServletRequest request, HttpServletResponse response) throws Exception {
		...
		listaReportisticaLuoghiInteresse = (ArrayList<ReportisticaLuoghiInteresse>) service.reportisticaLuoghiInteresse(user);
